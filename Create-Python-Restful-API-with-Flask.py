################################################################################################################################
# Prerequisites:  python -m pip install flask
# 
# How to run: 
# set FLASK_APP = Create-Python-Restful-API-with-Flask
# python -m flask --app Create-Python-Restful-API-with-Flask run
################################################################################################################################
...
#     return {"programming_languages":list(in_memory_datastore)}
...
#API call to create record / Get record
...
#API call to update record / Get record
